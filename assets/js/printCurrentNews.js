function printCurrentNews(news, containerToPrint) {
    ...
    let article = creatElement("div", "", "article")
    let article2 = creatElement("div", "", "article")
    ...
    if (subtitle.trim().length > 0){
      ...
      article.append(subtitleCurrentNews, firstParagraph)
      ...
      for (let i = 1; i < text.length; i++){
        if (i < 3) {
          ...
          article.append(currentParagraph)
        } else if(i === 3) {
          containerToPrint.append(article)
          counterParagraph += 4;
          let banner = creatElement("div", "", "adBanner");
          containerToPrint.append(banner)
          let paragraphText = text[i] + "."
          let currentParagraph = creatElement("p", paragraphText, "subtitleTextParagraph")
          article2.append(currentParagraph)
        } else if(i > 3) {
          let paragraphText = text[i] + "."
          let currentParagraph = creatElement("p", paragraphText, "subtitleTextParagraph")
          article2.append(currentParagraph)
        ...
        if(i == text.length - 1) {
          ...
          let divIcon = creatElement("div", "", "social tac")
          ...
          article2.append(currentParagraph, divIcon)
          containerToPrint.append(article2)
        } 
      }
    }
  }
